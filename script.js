    ...
    if (selectedService === 'whatsapp') {
        ...
        document.getElementById('result').innerHTML = `
            ...
            <div id="consultationButtons" class="text-center mt-4">
                <a href="https://www.fiverr.com/s/38KbPjY" class="btn btn-success">Book 30-Minute Call for $25 USD</a>
                <a href="https://www.fiverr.com/s/38KbPjY" class="btn btn-primary ml-3">Book 1-Hour Call for $50 USD</a>
            </div>
        `;
    } else {
